...
public class NetworkPlayer : NetworkBehaviour, ICardCollectionHelper
{
    [Header("����������")]
    ...
    public List<NetworkCard> hand = new();
    ...
    public async Task AddCard(GameObject newCard, bool repositionCards = false)
    {
        ...
        NetworkCard card = newCard.GetComponent<NetworkCard>();
    ...
    public NetworkCard RemoveCard(NetworkCard cardToRemove, bool repositionCards = true)
    {
        if (hand.Count == 0)
        {
            Debug.LogWarning("���� �����!");
